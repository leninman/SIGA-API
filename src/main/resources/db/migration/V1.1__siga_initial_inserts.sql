...
INSERT INTO usuarios (nombre, apellido, nombre_usuario, password, email, num_intentos_fallidos, activo, fecha_ultima_conexion) VALUES ('', '', 'director', '$2a$10$ngPl.9qJRx2hzFgOAGxoqenOPeRKxlh5.cxw3VaQ.rh/VPfVGQnIK', '', 0, true, '2023-04-30'),
('', '', 'administrativo', '$2a$10$xp0ikSHfvp3ayuft5S5A7eNH/ZlD4oPn6QZModtYqAK06.gY9iEU.', '', 0, true, '2023-04-30');
...
INSERT INTO cursos (annio,nivel,periodo_academico,seccion,turno) VALUES
...
INSERT INTO representantes (direccion,direccion_laboral,edad,email,empresa_donde_trabaja,activo,estado_civil,fecha_nacimiento,numero_documento,ocupacion,primer_apellido,primer_nombre,profesion,segundo_apellido,segundo_nombre,sexo,codigo_operadora_telefono,telefono,codigo_operadora_telefono_empresa,telefono_empresa,tipo_documento,lugar_de_nacimiento,nacionalidad,ingreso_mensual_aproximado) VALUES
...
INSERT INTO docentes (id, tipo_documento, numero_documento, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, sexo, fecha_nacimiento, fecha_ingreso, fecha_creacion, estado_civil, edad, pregrado1, pregrado2, postgrado1, postgrado2, curso1, curso2, curso3, curso4, graduado_pregrado1, categoria, tiempo_de_servicio, direccion,codigo_operadora_telefono, telefono, email, activo, condicion, lugar_de_nacimiento, nacionalidad, asignaturas_especializadas) VALUES (1, 'V', '9523698', 'MIGUEL', 'ANGEL', 'PALACIOS', 'FERNADEZ', 'MASCULINO', '1969-11-26', '2012-10-14', '2023-06-04', 'SOLTERO', '53', 'INGENIERO DE SISTEMAS', null, null, null, 'TECNICO EN TELECOMUNICACIONES', 'REDES DE COMPUTADORAS', '', '', 'SI', 'DOCENTE 1', 5, 'CALLE REAL DEL CEMENTERIO','0412', '5698877', 'mpfernadez@gmail.com', true, 'EN EJERCICIO', 'VENEZUELA', 'VENEZOLANA', 'FISICA,MATEMÁTICA');
INSERT INTO docentes (id, tipo_documento, numero_documento, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, sexo, fecha_nacimiento, fecha_ingreso, fecha_creacion, estado_civil, edad, pregrado1, pregrado2, postgrado1, postgrado2, curso1, curso2, curso3, curso4, graduado_pregrado1, categoria, tiempo_de_servicio, direccion,codigo_operadora_telefono,telefono, email, activo, condicion, lugar_de_nacimiento, nacionalidad,asignaturas_especializadas) VALUES (2, 'V', '6456789', 'MIGUEL', 'ANGEL', 'ESTEVA', 'RUIZ', 'MASCULINO', '1959-04-26', '2012-10-14', '2023-06-09', 'SOLTERO', '63', 'INGENIERO DE SISTEMAS', null, null, null, 'TECNICO EN TELECOMUNICACIONES', 'REDES DE COMPUTADORAS', '', '', 'SI', 'DOCENTE 3', 5, 'LOS FRAILES DE CATIA','0414', '9986756', 'mesteva@gmail.com', true, 'EN EJERCICIO', 'VENEZUELA', 'VENEZOLANA', 'FISICA,MATEMÁTICA');

INSERT INTO cursos_docentes (id, docente, curso, materia) VALUES (1, 1, 15, 5);
INSERT INTO cursos_docentes (id, docente, curso, materia) VALUES (2, 2, 15, 30);
