...
public interface ICursoRepo extends JpaRepository<Curso, Long> {
    ...
    Optional<Curso> findCursoByAnnioAndSeccionAndTurnoAndNivelAndPeriodoAcademico(String annio,String seccion,String turno,String nivel,String periodoAcademico);
